            ...
            <aside>
                ...
                while ($tag = $lesInformations->fetch_assoc())
                {
                    ...
                    <article>
                        ...
                        <nav>
                            <a href=<?php echo "tags.php?tag_id=".$tag['id'] ?> ><u>Voir les messages avec ce tag</u></a>
                        </nav>
                    </article>
                <?php } ?>
            </aside>
            <main>
                <h2>Utilisatrice.eur.s</h2>
                <?php
                /*
                ...
                while ($tag = $lesInformations->fetch_assoc())
                {
                    ...
                    <article>
                        ...
                        <nav>
                            ...
                            <a href=<?php echo "feed.php?user_id=" . $tag['id'] ?>><u>Flux</u></a>
                            <a href=<?php echo "settings.php?user_id=". $tag['id']?> ><u>Paramètres</u></a>
                            <a href=<?php echo "followers.php?user_id=".$tag['id']?>><u>Suiveurs</u></a>
                            <a href=<?php echo "subscriptions.php?user_id=".$tag['id']?>><u>Abonnements</u></a>
                        </nav>
                    </article>
                <?php } ?>
            </main>
